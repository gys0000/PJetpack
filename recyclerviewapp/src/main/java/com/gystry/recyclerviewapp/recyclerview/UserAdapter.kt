...
class UserAdapter(context: Context, userList: ArrayList<User>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onViewAttachedToWindow(holder: RecyclerView.ViewHolder) {
        ...
        Log.e(TAG, "onViewAttachedToWindow-oldPosition: ${holder.oldPosition}---layoutPosition:${holder.layoutPosition}" )
    }

    override fun onViewDetachedFromWindow(holder: RecyclerView.ViewHolder) {
        super.onViewDetachedFromWindow(holder)
        Log.e(TAG, "onViewDetachedFromWindow-oldPosition: ${holder.oldPosition}----layoutPosition:${holder.layoutPosition}" )
    }
